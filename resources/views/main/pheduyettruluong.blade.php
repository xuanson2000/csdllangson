...
<div class="container" style="background-color: white; padding: 20px 20px 20px 30px; width: 100%;">
  ...
  <h4 style="margin-bottom: 20px; margin-top: 20px;">DANH SÁCH HỒ SƠN CẤP PHÉP KHAI THÁC KHOÁNG SẢN</h4>            
  <table class="table table-bordered">
    ...
    <tbody>
      <tr>
        ...
        <td>  <a title="Xóa" href="">  <img alt="Sửa" src="public/anh/b_edit.png"> </a> <a title="Chỉnh sửa" href="{{route('chinhsuahosocapphepkhaithac')}}"><img alt="Xóa" src="public/anh/b_drop.png"></a> </td>
      </tr>
        <tr>
        <td>1</td>
        <td>1005/GP-UBND</td>
