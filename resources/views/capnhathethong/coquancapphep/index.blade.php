...
<div class="container" style="background-color: white; padding: 20px 20px 20px 30px; width: 100%;">
 ...
 <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  ...
  <table class="table table-bordered">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>{{$coQuanCapPhep->tenCoQuan}}</td>
        <td>{{$coQuanCapPhep->ghiChu}}</td>
        <td style="text-align: center;"> 
        	<a title="Sửa" href="{{route('suacoquancapphep',[$coQuanCapPhep->id])}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>  
          <a title="Xóa" onclick="return xacnhanxoa('Bạn có chắc chắn muốn xóa không')"   href="{{route('xoacoquancapphep',[$coQuanCapPhep->id])}}"><i class="fa fa-trash" aria-hidden="true"></i></a>
        </td>
      </tr>
      @endforeach
  ...
  <button  style="float: right; font-size: 14px;" type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus-square" aria-hidden="true"></i> Thêm mới</button>
      ...
      <div class="modal-content">
        ...
        <!-- Modal Header -->
          <div class="" style="background-color: #4F78F4; height: 40px;">
           <h4 style="float: left; margin: 10px 10px 10px 10px; color: white; font-family: Helvetica;">Thêm cơ quan cấp phép</h4>
        ...
        <div class="modal-body">
        		...
        		<form action="{{route('themcoquancapphep')}}" method="POST" enctype="multipart/form-data">
