    ...
    <tbody>
      ...
      <tr>
        ...
        <td style="text-align: center;"> 
        	<a title="Sửa" href="{{route('suachucvu',[$chucVu->id])}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>  
          <a title="Xóa" onclick="return xacnhanxoa('Bạn có chắc chắn muốn xóa không')"   href="{{route('xoachucvu',[$chucVu->id])}}"><i class="fa fa-trash" aria-hidden="true"></i></a>
        </td>
      </tr>
      @endforeach
      ...
      <div class="modal-content">
        ...
        <!-- Modal Header -->
          <div class="" style="background-color: #4F78F4; height: 40px;">
           <h4 style="float: left; margin: 10px 10px 10px 10px; color: white; font-family: Helvetica;">Thêm chức vụ</h4>
        ...
        <div class="modal-body">
        		...
        		<form action="{{route('themChucVu')}}" method="POST" enctype="multipart/form-data">
              <input type="hidden"  name="_token" value="{{csrf_token()}}" >
              <div class="form-group">
               <label for="usr">Tên chức vụ  <span style="color: red;">(*)</span></label>
               <input type="text" class="form-control" name="tenChucVu" required="">
             </div>
        		<div class="form-group">
