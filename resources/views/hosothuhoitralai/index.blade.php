...
<div class="container" style="background-color: white; padding: 20px 20px 20px 30px; width: 100%;">
 ...
 <div class="col-md-10 form-group" style="margin-top: 10px;">
  <h4 style=" color: white; font-weight: bold;">DANH SÁCH HỒ SƠ CẤP PHÉP KHAI THÁC KHOÁNG SẢN BỊ THU HỒI</h4>
</div>
  ...
  <table id="capphep"  class="table table-bordered">
    ...
    <tbody>
        ...
        @endif
    		...
    		<td> 
          <a  title="chi tiết" href="{{route('chitiethosobiendong',[$hoSoCapPhepKhaiThac ->id])}}" >Xem </a>
