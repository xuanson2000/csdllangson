   ...
   public function getlogin(){
...

    {
      ...
      $this->validate($request,
       ...
       'matkhau.min'=>'mật khẩu phải dài hơn 6 ký tự',
       'matkhau.max'=>'mật khẩu không được dài quá 20 ký tự',
      ...
      if (Auth::guard('quantri')->attempt($arr)) {
        ...
        if( $item==null)
        {
         return redirect()->route('reset_dangnhap',[$itemid]);
                ...
                return redirect()->route('khoangsan');
     ...
     return redirect()->back()->with('loginerror','Tài khoản hoặc mật khẩu không đúng !');
